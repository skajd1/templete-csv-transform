...
row = []
rdr_list = list(rdr)
while (x := (int(input("변환할 행 번호를 입력하세요 : ")))):
    x -=1
    print("========================================================================")
    selected_row = rdr_list[x]
    print("✅위치 :", selected_row[5], " (건물명: ", selected_row[1], ")")
    print("✅금액 : 보증금", selected_row[8].split('/')[0], "월세", selected_row[8].split('/')[1])
    print("✅전용면적 : ",selected_row[9], "㎡ ", "( 약 ",round(float(selected_row[9]) / 3.3  , 1) , " 평 )",sep='')
    print("✅방향 :", selected_row[13])
    print("✅구조 :", selected_row[7])
    print("✅입주가능일 :", selected_row[6])
    print("✅주차대수 : ", selected_row[14], "대",sep='')
    print("✅사용승인일 : ", selected_row[15], "년\n",sep='')
